...
#raiz.iconbitmap("led.ico")#cambia el icono de la pantalla 
...
#Titulo
TituloReproductor=Label(framePrincipal,text="Reproductor GUI", font=("ROBOTO",20),bg="#4d4d4d",fg="#f4f4f4")# , despues del tamaño de fuente pone una tipografia(negritas, subrayado, etc)
TituloReproductor.pack()

#Boton Open File
BotonOpenFile=Button(framePrincipal,text="Open File",font=("ROBOTO",20),bg="#5dc460"
